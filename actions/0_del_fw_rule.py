...
class InternalDelFwRule(Action):
    def run(self, deviceIP, cmd_path, fw_instance_name, rule_number):
        ...
        url_base = "https://" + deviceIP + "/" + cmd_path + "/delete/security/firewall/name/" + fw_instance_name + "/rule/" + str(rule_number)
        url = url_base
