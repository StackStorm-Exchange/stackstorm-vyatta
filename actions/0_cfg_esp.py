...
class InternalCfgEsp(Action):
    def run(self, deviceIP, cmd_path, proposal, espGroup, encryption, hashAlg, lifetime):
        ...
        url_base = "https://" + deviceIP + "/" + cmd_path + "/set/security/vpn/ipsec/esp-group/" + espGroup
